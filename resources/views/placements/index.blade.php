...
<header class="rounded-3xl bg-white border border-slate-200 p-8">
    ...
    <section class="mt-8 grid md:grid-cols-4 gap-4">
      <article class="stat-card rounded-xl bg-white border border-slate-200 p-5"><p class="text-sm text-slate-500">Average Package</p><p class="mt-2 text-3xl font-bold text-sgcNavy">INR 4-6 LPA</p></article>
      ...
      <article class="stat-card rounded-xl bg-white border border-slate-200 p-5"><p class="text-sm text-slate-500">Top Scholarship</p><p class="mt-2 text-3xl font-bold text-sgcNavy">INR 1 Lakh</p></article>
    </section>
    ...
    <section class="mt-8 grid lg:grid-cols-2 gap-6">
      <article class="rounded-2xl bg-white border border-slate-200 p-7">
        ...
        <ul class="mt-8 list-disc pl-6 text-sm text-slate-700 space-y-2">
          ...
          <li>Chief Minister's Scholarship (INR 1 lakh) awarded to eligible students in 2023-24.</li>
      ...
      <article class="rounded-2xl bg-white border border-slate-200 p-7 table-wrap">
        ...
        <table class="table-mobile-cards mt-8 min-w-full text-sm">
          ...
          <tbody>
            <tr class="border-b border-slate-100"><td data-label="Company" class="py-3 pr-4">TCS</td><td data-label="Role" class="py-3 pr-4">Associate System Engineer</td><td data-label="Package" class="py-3 pr-4">INR 4.2 LPA</td><td data-label="Year" class="py-3 pr-4">2025</td></tr>
            <tr class="border-b border-slate-100"><td data-label="Company" class="py-3 pr-4">Wipro</td><td data-label="Role" class="py-3 pr-4">Project Engineer</td><td data-label="Package" class="py-3 pr-4">INR 4.8 LPA</td><td data-label="Year" class="py-3 pr-4">2025</td></tr>
            <tr class="border-b border-slate-100"><td data-label="Company" class="py-3 pr-4">Cognizant</td><td data-label="Role" class="py-3 pr-4">Programmer Analyst Trainee</td><td data-label="Package" class="py-3 pr-4">INR 5.6 LPA</td><td data-label="Year" class="py-3 pr-4">2026</td></tr>
            <tr><td data-label="Company" class="py-3 pr-4">South Indian Bank</td><td data-label="Role" class="py-3 pr-4">Probationary Officer</td><td data-label="Package" class="py-3 pr-4">INR 6.0 LPA</td><td data-label="Year" class="py-3 pr-4">2026</td></tr>
          </tbody>
        </table>
      </article>
    </section>
