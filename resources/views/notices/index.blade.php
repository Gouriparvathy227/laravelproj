...
<header class="rounded-3xl bg-white border border-slate-200 p-8">
    ...
    <section class="mt-8 grid lg:grid-cols-2 gap-6">
      <article class="rounded-2xl bg-white border border-slate-200 p-7">
        ...
        <a href="#" class="mt-6 inline-block rounded-lg border border-slate-300 px-4 py-2 text-sm hover:bg-slate-50 focus-ring">Download Academic Calendar PDF</a>
      </article>

      <article class="rounded-2xl bg-white border border-slate-200 p-7">
        <h2 class="section-title font-heading text-2xl text-sgcNavy">Exam & Hall Ticket Links</h2>
        <div class="mt-8 space-y-3 text-sm">
          <a href="#" class="block rounded-lg border border-slate-200 px-4 py-3 hover:bg-slate-50 focus-ring">Semester VI Hall Ticket Download</a>
          <a href="#" class="block rounded-lg border border-slate-200 px-4 py-3 hover:bg-slate-50 focus-ring">University Exam Notification (MGU)</a>
          <a href="#" class="block rounded-lg border border-slate-200 px-4 py-3 hover:bg-slate-50 focus-ring">Internal Assessment Schedule</a>
        </div>
      </article>
    </section>
@endsection
