...
<header class="rounded-3xl bg-white border border-slate-200 p-8">
    ...
    <section class="mt-8 rounded-2xl bg-white border border-slate-200 p-7 table-wrap">
      ...
      <table class="table-mobile-cards mt-8 min-w-full text-sm">
        ...
        <tbody>
          <tr class="border-b border-slate-100"><td data-label="Program" class="py-3 pr-4">B.Sc. Physics</td><td data-label="Duration" class="py-3 pr-4">3 Years</td><td data-label="Type" class="py-3 pr-4">Aided</td><td data-label="Approx. Fee" class="py-3 pr-4">~?6,970/year</td><td data-label="Highlights" class="py-3 pr-4">Research Centre, DST-FIST</td></tr>
          <tr class="border-b border-slate-100"><td data-label="Program" class="py-3 pr-4">B.Sc. Chemistry</td><td data-label="Duration" class="py-3 pr-4">3 Years</td><td data-label="Type" class="py-3 pr-4">Aided</td><td data-label="Approx. Fee" class="py-3 pr-4">~?6,970/year</td><td data-label="Highlights" class="py-3 pr-4">Research Centre, DST-FIST</td></tr>
          <tr class="border-b border-slate-100"><td data-label="Program" class="py-3 pr-4">B.Sc. Botany</td><td data-label="Duration" class="py-3 pr-4">3 Years</td><td data-label="Type" class="py-3 pr-4">Aided</td><td data-label="Approx. Fee" class="py-3 pr-4">~?6,970/year</td><td data-label="Highlights" class="py-3 pr-4">Field studies</td></tr>
          ...
          <tr><td data-label="Program" class="py-3 pr-4">B.Com (+ Additional stream)</td><td data-label="Duration" class="py-3 pr-4">3 Years</td><td data-label="Type" class="py-3 pr-4">Aided</td><td data-label="Approx. Fee" class="py-3 pr-4">~?6,970/year</td><td data-label="Highlights" class="py-3 pr-4">Commerce and banking focus</td></tr>
        </tbody>
      </table>
    </section>
    ...
    <section class="mt-8 grid lg:grid-cols-3 gap-6">
      ...
      <aside class="rounded-2xl bg-sgcNavy text-white p-7">
        ...
        <a href="{{ route('notices.index') }}" class="mt-6 inline-block rounded-lg bg-sgcGold px-4 py-2 text-sm font-medium hover:bg-amber-700 focus-ring">Download Calendar PDF</a>
      </aside>
    </section>
@endsection
